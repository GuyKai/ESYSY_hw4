...
const static char DEVICE_NAME[] = "Button_123";
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        uint8_t id[9] = {'b', '0', '8', '9', '0', '1', '1', '0', '8'};

        _button_service = new ButtonService(_ble, false /* initial value for button pressed */,false ,id);
    ...
    void button_pressed(void) {
        ...
        _event_queue.call(Callback<void(uint8_t[9])>(_button_service, &ButtonService::updateIDstate),id1);
        _event_queue.call(Callback<void(bool)>(_button_service, &ButtonService::updateButtonState), true);
        //_event_queue.call(Callback<void(void)>(_button_service, &ButtonService::IDstate1));
    }
    
    void button_released(void) {
        
        _event_queue.call(Callback<void(uint8_t[9])>(_button_service, &ButtonService::updateIDstate),id2);
        _event_queue.call(Callback<void(bool)>(_button_service, &ButtonService::updateButtonState), false);
        //_event_queue.call(Callback<void(void)>(_button_service, &ButtonService::IDstate2));
    }

    void on_data_written(const GattWriteCallbackParams *params) {
        if ((params->handle == _button_service->getValueHandle()) && (params->len == 1)) {
            _led2 = *(params->data);
        }
    }
...
private:
    ...
    uint8_t id1[9] = {'b', '0', '7', '9', '0', '1', '1', '2', '3'};
    uint8_t id2[9] = {'b', '0', '8', '9', '0', '1', '1', '0', '8'};
};
